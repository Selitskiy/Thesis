classdef IDSInputClassNet < MLPInputClassNet
    ...
    methods
        ...
        function net = IDSInputClassNet(mb_size)
            net = net@MLPInputClassNet();
            net.mb_size = mb_size;
        end
        ...
        function [net, TInfo] = Train(net, inputDS)

            fprintf('Training %s net\n', net.name); 

            [tNet, TInfo] = trainNetwork(inputDS, net.lGraph, net.options);
            net.trainedNet = tNet;
