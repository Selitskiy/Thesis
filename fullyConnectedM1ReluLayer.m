classdef fullyConnectedM1ReluLayer < nnet.layer.Layer % & nnet.layer.Formattable (Optional)
    ...
    methods
        function layer = fullyConnectedM1ReluLayer(name, numInChannels, numLabelChannels, numOutChannels)
        ...
        function [Z] = predict(layer, X)
            ...
            %Z = relu(layer.W * X(1:layer.numInChannels, :) + layer.W0);

            Z = relu(layer.W * X(1:layer.numInChannels - layer.numLabelChannels, :) + layer.W0);
