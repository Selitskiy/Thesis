classdef fullyConnectedCLLayer < nnet.layer.Layer %& nnet.layer.Formattable
    ...
    methods
        function layer = fullyConnectedCLLayer(name, numInChannels, numLabelChannels, numRealOutChannels, numOutChannels, lMax, MMax)
            ...
            layer.Description = "FullyConnectedCL" + numInChannels + " channels";
            ...
            bound = sqrt(6 / (layer.numOutChannels + layer.numInChannels - layer.numLabelChannels));
            layer.W = bound * (2. * rand([layer.numOutChannels, layer.numInChannels - layer.numLabelChannels],'single') - 1.);
        ...
        function [Z, M, MFill, MCurr] = predict(layer, X)
            ...
            %Z = layer.W * X(1:layer.numInChannels, :) + layer.W0;
